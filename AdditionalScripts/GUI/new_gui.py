...
# Import de scripts locaux
import AdditionalScripts.HiddenData.links_opening as links
import AdditionalScripts.HiddenData.logs_config as logs
import AdditionalScripts.GUI.ToolTip as tooltip
import AdditionalScripts.HiddenData.hotkeys as hotkeys
...
def ui():
    ...
    # Définition d'une fonction pour cacher les raccourcis dans les menus
    def HideHotkeys():
    ...
    StudentDropDown = ttk.Combobox(root, values=sorted(liste), state="readonly")
