...
#  Apr 19, 2023 11:46:44 AM CEST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 569x252+324+205
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
### SPOT dump_widget_opt A
    ...
    place $top.but53 \
        -in $top -x 0 -relx 0.629 -y 0 -rely 0.532 -width 162 -relwidth 0 \
        -height 35 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but54 \
        -in $top -x 0 -relx 0.629 -y 0 -rely 0.333 -width 162 -relwidth 0 \
        -height 35 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but55 \
